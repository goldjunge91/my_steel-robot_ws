 ...
 */
void
PubEntities::createEntities(rcl_node_t *node, rclc_support_t *support) {
    rclc_publisher_init_default(
        &xPublisher, node, ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, Int32), "pico_rnd");

    rclc_publisher_init_default(&xPubJoint,
                                node,
    ...
    rclc_subscription_init_default(
        &xSubPose, node, ROSIDL_GET_MSG_TYPE_SUPPORT(geometry_msgs, msg, PoseStamped), "do_pose");
 ...
 */
void
PubEntities::destroyEntities(rcl_node_t *node, rclc_support_t *support) {
    xCount = 0;
 ...
 */
void
PubEntities::addToExecutor(rclc_executor_t *executor) {
 ...
 */
void
PubEntities::handleSubscriptionMsg(const void *msg, uRosSubContext_t *context) {
    BaseType_t res;
    TableCmd_t cmd;
 ...
 */
double
PubEntities::angleDiffAbs(double a1, double a2) {
