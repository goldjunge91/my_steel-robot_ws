...
#define PUB_Q_LEN 128
#define UROS_MAX_PUB_MSGS 10
...
public:
     ...
     */
    bool publish(rcl_publisher_t *publisher, void *msg, uRosEntities *entities, void *arg);
    ...
    /***
     * Return whether the uROS session is ready (agent connected and entities created)
     */
    bool isSessionReady() {
        return xSessionReady;
    }
