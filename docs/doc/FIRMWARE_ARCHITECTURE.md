---
title: Firmware
summary: Real-time firmware architecture and design documentation
description: Comprehensive documentation of the Raspberry Pi Pico firmware running FreeRTOS with micro-ROS for real-time motor control and sensor interfacing
keywords: pico, firmware, freertos, micro-ros, real-time, motor control
author: goldjunge91
omega: true
order: 3
---
...
!!! info "Real-time Performance"
    The firmware achieves the following performance characteristics on the Raspberry Pi Pico:
